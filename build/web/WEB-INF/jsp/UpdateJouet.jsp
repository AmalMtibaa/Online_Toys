<%-- 
    Document   : UpdateJouet
    Created on : 26 janv. 2018, 09:10:18
    Author     : asus
--%>
...
<html>
   ...
   <div class="form">
        ...
        <div id="signup">   
            ...
            <h1 style="color: white;"><b>Update Jouet</b></h1>
          
          <form:form method="post" modelAttribute="jouet" action="UpdateJouet" id="formula">
          ...
          <div class="field-wrap">
            Prix:
            <form:input path="prix" type="number"  required="required" />
          </div>
          ...
          <div class="field-wrap">
            ...
            <form:input path="stock" type="number" />
              ...
              <div class="field-wrap">    
             Photo
            <form:input type="test" path="photo" />
